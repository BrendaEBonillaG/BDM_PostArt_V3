        ...
        <div class="card_proyecto">
            <a href="proyecto.html">
                <div class="card_proyecto_img">
                    <img class="img_proyecto"
                        src="../BDM_PostArt_V3/imagenes-prueba/2f0bb0f234c9dabd561a55dc1a36a944.jpg" alt="">
                </div>

                <div class="card_proyect_text">

                    <p class="estado">Proyecto</p>
                    <p class="date">Published 18 april 2025</p>
                    <h1 class="titulo">New proyect</h1>
                    <p class="parrafo">these parrafo es para hablar un poco sobre la dsecription de el proyecto</p>

                    <div class="autor_cart_proyecto">
                        <div class="avatar_autor_proyecto">
                            <img src="../BDM_PostArt_V3/imagenes-prueba/User2.jpg" alt="">
                            <p class="autor_name_proyect">Jane Doe</p>
                        </div>
                    </div>
                </div>
            </a>
        </div>
        <!-- fin de la carta de proyecto -->
