...
<!-- posts -->
    <div class="container-picture-dashboard">
        ...
        <div class="contenedor_proyecto_publicado">
            ...
            <div class="../BDM_PostArt_V3/imagenes_del_proyecto">
                <div class="carrusel_../BDM_PostArt_V3/imagenes">
                    <img src="imagen1.jpg" alt="Imagen del proyecto 1" class="imagen_proyecto">
                    <img src="imagen2.jpg" alt="Imagen del proyecto 2" class="imagen_proyecto">
                    <img src="imagen3.jpg" alt="Imagen del proyecto 3" class="imagen_proyecto">
                </div>
            </div>
    
            <div class="descripcion_del_proyecto">
                <h2>Descripción</h2>
                <p>Aquí va la descripción detallada del proyecto. Explica de qué se trata, cuál es su objetivo y por qué la gente debería apoyarlo.</p>
            </div>
            ...
            <div class="boton_formar_parte">
                <button class="boton_unirse">¡Quiero formar parte del proyecto!</button>
            </div>
        </div>
